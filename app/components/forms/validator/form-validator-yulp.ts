...
export function validate<Values>(values: Values, schema: Schema): Promise<MaxfriseErrors<Values>> {
...
function yupToFormErrors<Values>(yupError: ValidationError): MaxfriseErrors<Values> {
    let errors: any = {}
